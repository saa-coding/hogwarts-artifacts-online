...
class ArtifactControllerTest {
    ...
    void testAddArtifactSuccess() throws Exception {
        ...
        ArtifactDto artifactDto = new ArtifactDto
                (null, "Remembrall", "Desc", "imageUrl", null);
        ...
        //When and then
        this.mockMvc.perform(post("api/v1/artifacts").contentType(MediaType.APPLICATION_JSON).accept(MediaType.APPLICATION_JSON))
                .andExpect(jsonPath("$.flag").value(true))
                .andExpect(jsonPath("$.code").value(StatusCode.SUCCESS))
                .andExpect(jsonPath("$.message").value("Find All Success"))
    ...
    void testUpdateArtifactSuccess() throws Exception {
        ...
        //When and then
        this.mockMvc.perform(put("api/v1/artifacts/1250808601744904192").contentType(MediaType.APPLICATION_JSON).accept(MediaType.APPLICATION_JSON))
                .andExpect(jsonPath("$.flag").value(true))
                .andExpect(jsonPath("$.code").value(StatusCode.SUCCESS))
